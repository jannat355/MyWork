      ...
      <div>
        {cart.length === 0 && (
          <div className="text-center ">
            <h3 className="fs-1 fst-italic fw-bolder text-danger">
      ...
      <div>
        {cart.map((singleCart) => {
          ...
          return (
            <div
              key={id}
              className="row justify-content-between align-items-center my-4 shadow p-5"
            >
              ...
              <div className="col-md-6 d-flex flex-column justify-content-between">
                ...
                <div>
                  ...
                  <div className="d-flex justify-content-between">
                    <div>
                      <button
                        onClick={() => handleIncrease(singleCart)}
                    ...
                    <div>
                      <button
                        onClick={() => handleDecrease(singleCart)}
